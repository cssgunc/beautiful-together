    ...
    return (
        <div className="flex flex-col items-center m-5 gap-5">
            ...
            <div className="flex flex-col shadow-lg w-full">
                <div className="flex flex-col items-center bg-brand-orange-200 p-5 gap-2">
                    <div className="text-white text-xl font-bold">Ready to meet your match?</div>
                    <div className="bg-brand-orange-400 rounded-full p-2 text-white">
            ...
            <div className="flex flex-col text-lg gap-3">
                ...
                <button onClick={() => navigate('/catform')} className="flex flex-row align-center justify-center gap-2 bg-brand-green text-white rounded p-3 font-bold shadow-md">
                ...
                <button onClick={() => navigate('/dogform')} className="flex flex-row align-center justify-center gap-2 bg-brand-orange-400 text-white rounded p-3 font-bold shadow-md">
