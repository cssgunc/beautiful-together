    ...
    return (
        <div className="flex flex-col items-center m-5 gap-5">
            ...
            <div className="flex flex-col text-lg gap-3">
                ...
                <button onClick={() => navigate('/login')} className="flex flex-row align-center justify-center gap-2 bg-green-300 text-white rounded p-3 font-bold shadow-md">
                ...
                <button onClick={() => navigate('/signup')} className="flex flex-row align-center justify-center gap-2 bg-orange-400 text-white rounded p-3 font-bold shadow-md">
